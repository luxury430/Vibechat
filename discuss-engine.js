...
.de-steps-track {
  display: flex; flex: 1;
  transition: transform .3s cubic-bezier(.22,.1,.36,1);
  /* NOTE: overflow:hidden intentionally removed — .de-compose-sheet already
     has overflow:hidden which clips both panels correctly. Keeping it here
     would clip Step 2 at layout time (before translateX runs), making it
     invisible even after the slide transition. */
}
